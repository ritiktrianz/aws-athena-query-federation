...
public class RedshiftMuxRecordHandlerTest {
    ...
    public void testCreateJdbcRecordHandler() {
        validateRecordHandler(this.mockConfig, this.configOptions);
    }

    private void validateRecordHandler(DatabaseConnectionConfig config, Map<String, String> options) {
        JdbcRecordHandler recordHandler = this.factory.createJdbcRecordHandler(config, options);
