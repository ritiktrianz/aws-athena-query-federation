...
public class Db2PredicateBuilderTest
{
    ...
    public void buildConjuncts_WithPartitionColumn_FiltersOutPartitionColumn()
    {
        ...
        // Create split with partition column in properties (DB2-style: partition columns are excluded from conjuncts)
        Map<String, String> splitProperties = new HashMap<>();
        splitProperties.put("partition_col", "0");
        ...
        // Should only have conjunct for intCol, not partition_col
    ...
    private List<String> buildConjuncts(Map<String, ValueSet> constraintMap, List<Field> fields, Split customSplit)
    {
        ...
        Db2PredicateBuilder predicateBuilder = new Db2PredicateBuilder();
