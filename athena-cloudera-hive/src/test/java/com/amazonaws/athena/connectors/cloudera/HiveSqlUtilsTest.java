...
public class HiveSqlUtilsTest
{
    ...
    public void buildSql_WithPartitionClause_GeneratesQueryWithPartition()
    {
        ...
        String expectedSql = "SELECT null FROM test_schema.test_table  WHERE p0 = 'value'";

        List<TypeAndValue> parameterValues = new ArrayList<>();
        String sql = HiveSqlUtils.buildSql(tableName, schema, constraints, splitWithPartition, parameterValues);
    ...
    public void buildSql_WithEmptySchema_GeneratesQueryWithNull()
    {
        ...
        List<TypeAndValue> parameterValues = new ArrayList<>();
        String sql = HiveSqlUtils.buildSql(tableName, emptySchema, constraints, split, parameterValues);
