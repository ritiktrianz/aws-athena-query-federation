...
import com.amazonaws.athena.connectors.cloudera.query.HiveQueryBuilder;
import com.amazonaws.athena.connectors.cloudera.query.HiveQueryFactory;
...
{
    private static final HiveQueryFactory queryFactory = new HiveQueryFactory();
    
    private HiveSqlUtils()
    {
    }
     ...
     *
     * @return The HiveQueryFactory instance
     */
    public static HiveQueryFactory getQueryFactory()
    {
        return queryFactory;
    }
     ...
     * Hive using StringTemplate approach.
     *
     * @param catalogName The catalog name (database name in Hive).
     ...
     */
    public static String buildSql(String catalogName, TableName tableName, Schema schema, Constraints constraints, Split split, List<TypeAndValue> parameterValues)
    {
        HiveQueryBuilder queryBuilder = queryFactory.createQueryBuilder();
