...
import com.amazonaws.athena.connectors.saphana.query.SaphanaQueryBuilder;
import com.amazonaws.athena.connectors.saphana.query.SaphanaQueryFactory;
 ...
 */
public class SaphanaSqlUtils
{
    private static final SaphanaQueryFactory queryFactory = new SaphanaQueryFactory();
    
    private SaphanaSqlUtils()
    {
    }
     ...
     *
     * @return The SaphanaQueryFactory instance
     */
    public static SaphanaQueryFactory getQueryFactory()
    {
        return queryFactory;
    }
     ...
     * SAP HANA using StringTemplate approach.
     *
    ...
    {
        SaphanaQueryBuilder queryBuilder = queryFactory.createQueryBuilder();
        
        // SAP HANA uses catalog.schema.table format
        String sql = queryBuilder
                .withCatalog(null) // SAP HANA doesn't use catalog in FROM clause
