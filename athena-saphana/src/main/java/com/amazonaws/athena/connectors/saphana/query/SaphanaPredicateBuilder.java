...
import com.amazonaws.athena.connectors.saphana.SaphanaFederationExpressionParser;
...
public class SaphanaPredicateBuilder extends JdbcPredicateBuilder
{
    private static final Logger LOGGER = LoggerFactory.getLogger(SaphanaPredicateBuilder.class);

    public SaphanaPredicateBuilder()
    {
        super(SAPHANA_QUOTE_CHARACTER, new SaphanaQueryFactory());
    }
                                       ...
                                       List<TypeAndValue> parameterValues, Split split)
    {
        ...
        builder.addAll(new SaphanaFederationExpressionParser(SAPHANA_QUOTE_CHARACTER).parseComplexExpressions(columns, constraints, parameterValues));
        return builder;
    }
}
