...
public class SaphanaPredicateBuilderTest
{
    ...
    public void buildConjuncts_WithSingleValueRange_ReturnsEqualityPredicate()
    {
        ...
        List<String> conjuncts = buildConjuncts(fields);
    ...
    private List<String> buildConjuncts(List<Field> fields)
    {
        return buildConjuncts(fields, split);
    }
    ...
    private List<String> buildConjuncts(List<Field> fields, Split customSplit)
    {
        ...
        SaphanaPredicateBuilder predicateBuilder = new SaphanaPredicateBuilder();
