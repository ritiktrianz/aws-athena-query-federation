...
/**
 * Impala implementation of FederationExpressionParser using StringTemplate.
 ...
 */
public class ImpalaFederationExpressionParser extends TemplateBasedJdbcFederationExpressionParser
{
    ...
    {
        return ImpalaSqlUtils.getQueryFactory();
    }
}
