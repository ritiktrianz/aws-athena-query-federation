...
public class ImpalaQueryBuilderTest
{
    ...
    {
        Schema schema = createSchema("col1", Types.MinorType.INT, "col2", Types.MinorType.VARCHAR);
    ...
    {
        Schema schema = createSchema("col1", Types.MinorType.INT);
        TableName tableName = createTableName();
        List<OrderByField> orderByFields = createOrderByFields("col1", OrderByField.Direction.ASC_NULLS_LAST);
    ...
    private Schema createSchema(String columnName, Types.MinorType type)
    {
        return SchemaBuilder.newBuilder()
                .addField(FieldBuilder.newBuilder(columnName, type.getType()).build())
                .build();
    }

    private Schema createSchema(String columnName1, Types.MinorType type1, String columnName2, Types.MinorType type2)
    {
        return SchemaBuilder.newBuilder()
                .addField(FieldBuilder.newBuilder(columnName1, type1.getType()).build())
                .addField(FieldBuilder.newBuilder(columnName2, type2.getType()).build())
                .build();
    }
    ...
    private List<OrderByField> createOrderByFields(String columnName, OrderByField.Direction direction)
    {
        return Collections.singletonList(new OrderByField(columnName, direction));
    }
